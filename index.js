    ...
    inquirer.prompt([{
        ...
        db.query(`SELECT * FROM employee, role`, (err, result) => {
            ...
            inquirer.prompt([
                ...
                db.query(`INSERT INTO employee (first-name, last_name, role_id, manager_id) VALUES (?, ?, ?)`, [answers.firstName, answers.lastName, role.id, answers.manager.id], (err, result) => {
                    if (err) throw err;
        ...
        db.query(`SELECT * FROM employee, role`, (err, result) => {
            ...
            inquirer.prompt([
                ...
                db.query(`UPDATE employee SET ? WHERE ?`, [{role_id: role}, {last_name}], (err, result) => {
                    if (err) throw err;
